...
f.gff=data.frame(f$name, 'SINEfinder', 'SINE', f$start, f$end, '.', '+', '.', paste('ID=', f$Name, ';Name=', paste(f$Name, f$mtec.fam, paste('TSDlen', f$TSD.len, sep=''), paste('TSDmismat', f$TSD.mism, sep=''), sep='_'), sep=''))
